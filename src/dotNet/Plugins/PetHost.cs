...
namespace DesktopPet.Plugins
{
    ...
    internal sealed class PetHost : IHost
    {
        ...
        internal void RaiseAnimationStarted(FormPet pet, int animationId) { var h = AnimationStarted; if (h != null) Safe(() => h(new AnimationInfo { Pet = HandleFor(pet), AnimationId = animationId })); }
