...
using DesktopPet.ModuleKit.Testing;
using DesktopPet.Modules;

namespace DesktopPet.WindowSoak
{
    /// <summary>
    ...
    {
        private const string DefaultTypeName = "DesktopPet.PetStudioModule.PetStudioWindow";
        private const string DefaultModuleRelativePath =
            @"build\DesktopPetPortable\bin\Release\x64\modules\petstudio\PetStudio.dll";
