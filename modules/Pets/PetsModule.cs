...
namespace DesktopPet.PetsModule
{
    ...
    public sealed class PetsModule : IModule
    {
        ...
        public void Init(IHost host)
        {
            ...
            // NOTE: the tray "Add a pet" / "Remove a pet" submenus stay HOST-owned (they carry the pet
            // icons). The module owning them as plain TrayItems dropped those icons, so that was reverted.
        }
