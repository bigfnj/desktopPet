...
- Negima! mascots added to the companions*
- The taskbar was always hiding the companion. Now the companion will try to set the topmost on each animation. Probably I have to remove this if you can't use the taskbar anymore...
